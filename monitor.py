...
subscription_id = "ff29343b-3d73-44c7-b0ce-9f33d4a50a7a"
resource_group = "rg-GenAIOps-dev"
aoai_deployment_name = "gpt-4"
aoai_connection_name = "aoai-connection"
project_name = "ai-project-butrkhj3nqgog"  # Ex: ai-project-lh7b37cbhixdq
endpoint_name = "rag-1118-2-endpoint"  # Ex: rag-PCLN-endpoint
deployment_name = "rag-1118-2-deployment"  # Ex: rag-PCLN-deployment
